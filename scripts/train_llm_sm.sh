#!/bin/bash
#SBATCH --job-name=train_prc_emo_sentiment_multitask
...
for seed in 42;
do
python ./src/ft_llm_cl_sentiment_multitask.py --do_eval_dev --do_eval_test --do_train --curriculum --bucket_number ${BN} \
